<?php
/**
 * Server-side rendering of the `wp-action-network-events/event-date` block.
 *
 * @package WordPress
 */
namespace WpActionNetworkEvents\App\Blocks\Event_Date;

/**
 * Renders the `wp-action-network-events/event-date` block on the server.
 *
